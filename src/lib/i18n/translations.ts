export const translations = {
  nl: {
    ...
    footer: {
      description:
        "Innovatieve oplossingen voor moderne uitdagingen. Wij zijn gespecialiseerd in AI-systemen, SaaS-platforms, KYC-integraties en winkelautomatisering.",
    ...
    about: {
      ...
      missionDescription:
        "Onze missie is om bedrijven te helpen groeien door middel van digitale innovatie. Wij geloven in het bouwen van hoogwaardige oplossingen die eenvoudig te gebruiken zijn en een echte impact hebben.",
  ...
  en: {
    ...
    footer: {
      description:
        "Creating innovative solutions for modern challenges. We specialize in AI systems, SaaS platforms, KYC integrations, and shop automations.",
    ...
    about: {
      ...
      missionDescription:
        "Our mission is to help businesses grow through digital innovation. We believe in building high-quality solutions that are easy to use and make a real impact.",
