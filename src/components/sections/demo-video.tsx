        ...
        >
          ...
          >
            ...
            <div className="flex justify-center">
              ...
              >
                <a
                  href={`mailto:info@virelio.nl?subject=${encodeURIComponent(language === 'nl' ? 'Plan een gesprek - Virelio' : 'Schedule a call - Virelio')}&body=${encodeURIComponent(language === 'nl' ? 'Hoi Virelio,\n\nIk wil graag een kennismakingsgesprek inplannen.\n\nMijn naam: \nBedrijf: \nTelefoonnummer: \n\nVoorkeur datum/tijd: \n\nGroet,' : 'Hi Virelio,\n\nI would like to schedule an introductory call.\n\nMy name: \nCompany: \nPhone number: \n\nPreferred date/time: \n\nBest regards,')}`}
