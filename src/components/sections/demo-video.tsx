        ...
        >
          ...
          >
            ...
            <div className="flex justify-center">
              ...
              >
                <a
                  href={`mailto:info@impulsoco.nl?subject=${encodeURIComponent(language === 'nl' ? 'Plan een gesprek - Impulso Co.' : 'Schedule a call - Impulso Co.')}&body=${encodeURIComponent(language === 'nl' ? 'Hoi Impulso Co.,\n\nIk wil graag een kennismakingsgesprek inplannen.\n\nMijn naam: \nBedrijf: \nTelefoonnummer: \n\nVoorkeur datum/tijd: \n\nGroet,' : 'Hi Impulso Co.,\n\nI would like to schedule an introductory call.\n\nMy name: \nCompany: \nPhone number: \n\nPreferred date/time: \n\nBest regards,')}`}
