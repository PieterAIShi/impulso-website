...
export const metadata: Metadata = {
  title: "AI Voice Assistant for Business | 24/7 Call Automation | Virelio",
  ...
  openGraph: {
    title: "AI Voice Assistant for Business | 24/7 Automation | Virelio",
