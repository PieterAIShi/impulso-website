...
export const metadata: Metadata = {
  title: "AI Voice Assistant for Business | 24/7 Call Automation | Impulso Co.",
  ...
  openGraph: {
    title: "AI Voice Assistant for Business | 24/7 Automation | Impulso Co.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Impulso Co. AI Voice Assistant - Automate Customer Calls",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "AI Voice Assistant | 24/7 Business Calls | Impulso Co.",
