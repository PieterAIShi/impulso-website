...
export const metadata: Metadata = {
  title: "AI Spraakassistent voor Bedrijven | 24/7 Klantgesprekken Automatiseren | Impulso Co.",
  ...
  openGraph: {
    title: "AI Spraakassistent voor Bedrijven | 24/7 Automatisering | Impulso Co.",
    ...
    siteName: "Impulso Co. — AI Agents op Maat",
    locale: "nl_NL",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Impulso Co. AI Spraakassistent - Automatiseer klantgesprekken",
      },
    ],
    videos: [
      {
  ...
  twitter: {
    ...
    title: "AI Spraakassistent | 24/7 Klantgesprekken | Impulso Co.",
